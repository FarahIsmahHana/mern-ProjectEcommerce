...
const categories = ["Laptop", "Smartphone", "Shirt", "Pants", "Cake", "Shoes", "Glasses"];
      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <div className="filterBox">
            ...
            <Slider value={price} onChange={priceHandler} valueLabelDisplay="auto" aria-labelledby="range-slider" min={0} max={100000000} />
